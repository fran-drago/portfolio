...
const es = {
  ...
  contact: {
    ...
    cv: { label: "CV", href: "https://drive.google.com/file/d/1Itn5MChjjRr9WYz4RZCOGETDdLuAXp5n/view?usp=sharing" },
    downloadCv: "Ver CV",
  },
...
const en: typeof es = {
  ...
  contact: {
    ...
    cv: { label: "CV", href: "https://drive.google.com/file/d/1X7UNhKRCGiYTbWibHRh2eNCwxl1-k3IN/view?usp=sharing" },
    downloadCv: "View CV",
  },
